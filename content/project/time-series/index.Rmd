...
```{r introPic, out.width = "50%", fig.show='hold', fig.align='default', echo=FALSE}
knitr::include_graphics("Bonneville_Dam.jpg")

```

***Figure. 1(a)*** *Bonneville Dam Spillway photo by Kirt Edblom on [flickr](https://www.flickr.com/photos/kirt_edblom/14150670993/in/photostream/).*

```{r introPic2, out.width = "50%", fig.show='hold', fig.align='default', echo=FALSE}
knitr::include_graphics("Steelhead.jpg")

```

***Figure. 1(b)*** *Oncorhynchus mykiss (Steelhead) at the Oregon Zoo Picture by User: Cacophony, published on [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Steelhead.jpg).*
